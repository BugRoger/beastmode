...
## Decision
12 labels across 3 categories: type (epic, feature), phase (backlog, design, plan, implement, validate, release, done), status (ready, in-progress, blocked). Status/review and gate/awaiting-approval were dropped. Phase and status labels are mutually exclusive — remove siblings before adding.
